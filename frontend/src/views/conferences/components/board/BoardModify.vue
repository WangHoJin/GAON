      ...
      <el-form :model="form" ref="form">
        ...
        <el-form-item>
          <el-row>
            ...
            <el-col :span="16">
              <el-button
                class="modify-cancle-btn"
                type="info"
                @click="submitCancle($route.params.pid)"
                >취소</el-button
              >
              <el-button
                type="primary"
                class="gaon-button modify-btn"
                @click="editPost('form', $route.params.pid)"
                >글 수정</el-button
              ></el-col
            >
            <!-- </el-main> -->
    ...
    $axios
      ...
      .then(res => {
        ...
        res.data.forEach((element, idx, arr) =>
          this.fileList.push({
            pfid: arr[idx].pfid,
            name: arr[idx].file_name,
            url: `${this.URL}/api/v1/boards/posts/files/${arr[idx].pfid}`
          })
        );
        // this.fileList
